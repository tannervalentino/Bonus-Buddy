...
![developer-mode](bonus-buddy/instructions/developer-mode.png)
5. Click **Load unpacked**
![load-unpacked](bonus-buddy/instructions/load-unpacked.png)
...
![update](bonus-buddy/instructions/update.png)
)
6. Click the **Reload** button on Bonus Buddy
![reload](bonus-buddy/instructions/reset-plugin.png)
